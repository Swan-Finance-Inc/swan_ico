              ...
              <div className="row">
                <div className="col-sm-12 col-md-6 col-md-offset-3">
                  ...
                  <div className="referral">
                    ...
                    <FacebookShareButton style={{ marginRight: '10px' }} url={`https://tokensale.zineum.io/signup/refer/${this.state.code}`} quote={`zineum.io introduces a unique tokensale platform for the Community.You can earn upto 2000 ZIN Coins , Sign-up`}>
                ...
                <div className="col-sm-12">
                  <div className="rules">
                    ...
                    <ol className="rule-list">
                      ...
                      <li>Please join our official <a href=" https://t.me/zineumofficial" target="_blank" className="link">Telegram group</a> and follow official <a href="https://twitter.com/zineum" target="_blank" className="link">twitter handle</a> to confirm participation.</li>
