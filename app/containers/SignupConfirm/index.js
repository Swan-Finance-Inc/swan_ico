          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-xs-5 col-sm-6 col-sm-6 col-md-2 clearfix">
                ...
                <div className="logo"><Link to="/"><img src={ logo } alt="swann" /></Link></div>
              </div>
            ...
            <div className="row">
              <div className="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                ...
                <div className="signin-card-body">
                  ...
                  <p> To avoid our email to you being considered as SPAM, please add the following email to your contact list: noreply@swanfinance.io</p>
                </div>
              </div>
            </div>
          </div>
