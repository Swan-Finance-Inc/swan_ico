        ...
        value: function render() {
            ...
            if (this.props.showAlert) {
                if (this.props.kycStatus === 'PENDING' || this.props.kycStatus === "incomplete") {
                    return _jsx('div', {
                        className: 'alert alert-danger large-text'
                    ...
                    return _jsx('div', {
                        className: 'alert alert-success large-text'
                    ...
                    return _jsx('div', {
                        className: 'alert alert-success large-text'
                    }, void 0, _jsx('span', {}, void 0, 'Verified Account. Now you can start investing by clicking on', _jsx(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], {
                        to: '/dashboard/contribution'
                    }, void 0, _jsx('span', {
                        className: 'alert-success',
                        onClick: function onClick() {
                            return _this2.props.toggleContActive();
                        }
                    }, void 0, ' Contribution'), '   '), ' button.'));
                } else {
                    return _ref7;
                }
            } else {
