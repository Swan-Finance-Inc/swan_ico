      ...
      return(
        <div id="content" className="ui-content ui-content-aside-overlay">
            ...
            <div className='row'>
            {
              ...
              <span className='goBackIcon'><img onClick={this.goBack} src='/assets/img/waka.svg' alt="goBack" /></span>
              </div>
              </div>
            ...
            <div className='col-md-6'>
              <div className="form-group enterBankAcc">
                <label htmlFor="bankAccNumber" className="form-label">Enter the Transaction number of Bank account</label>
                <input id="txhash" type="number" className="form-input form-control" required/>
              </div>
              </div>
            </div>
          <div className='row'>
          <div className='col-md-6'>
            <button className="form-button btn btn-primary" onClick={this.confirmPayment} >Confirm</button>
