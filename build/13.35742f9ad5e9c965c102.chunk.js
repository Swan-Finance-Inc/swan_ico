...
var MyReferal_MyReferal = function (_React$PureComponent) {
  ...
  _createClass(MyReferal, [{
    ...
    value: function render() {
      ...
      return _jsx('div', {
      ...
      }, void 0, console.log('refer social ****----*****----***', this.props.code.amountPercent), this.props.code.amountPercent > 0 ? _jsx(Refer["default"], {
        ...
        style: { alignItems: "center", marginTop: "35px", marginBottom: "45px", background: "#fff" }
      })))))));
    }
  }]);
